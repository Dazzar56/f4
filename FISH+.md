...
*   **Step 13 — редактор (если работаем по fish+) при позиции отличной от нулевой иногда при повторном открытии открывает совсем другое место. Критический баг, начать надо с него.
