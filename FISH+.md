...
*   **Step 19 — the rest of the odd hosts.** Whatever the compatibility issue turns up beyond the `ls` backend; `tools/fishplus_probe.sh` collects the raw material. Nothing is outstanding from the reports so far.
