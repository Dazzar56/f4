...
*   **Step 16a — server-to-server copy/move (S2S).** Direct copy/move between different remote hosts (Host A and Host B) using bidirectional `scp` (push/pull) probing, completely bypassing the client and resolving firewall/authorization constraints.
