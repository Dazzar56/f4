...
func TestDialogExactNormalLayout(t *testing.T) {
	...
	assertPos("name", d.nameEdit, 3, 3, 39, 3)
	assertPos("extension", d.extEdit, 42, 3, 76, 3)
	assertPos("name templates label", d.separators[4], 3, 4, 39, 4)
	assertPos("extension templates label", d.separators[5], 42, 4, 76, 4)
	assertPos("name templates", d.nameCombo, 3, 5, 32, 5)
	assertPos("name plus", d.namePlus, 35, 5, 37, 5)
	assertPos("extension templates", d.extCombo, 42, 5, 71, 5)
	assertPos("extension plus", d.extPlus, 74, 5, 76, 5)
	assertPos("preview", d.preview, 3, 10, 76, 20)
